...
║   VERSION : 6.3 — GUI FIRST FIX                         ║
║   BY      : Saycho                                       ║
╠══════════════════════════════════════════════════════════╣
║  ROOT CAUSE FIX v6.3:                                    ║
║  WaitForChild("Remotes") dijalankan SEBELUM GUI dibuat   ║
║  → kalau 1 remote tidak ada = script beku = GUI gelap    ║
║  FIX: Remote = {} kosong dulu, isi di task.spawn         ║
║       setelah seluruh GUI selesai dibuat                 ║
╚══════════════════════════════════════════════════════════╝
]]
