...
SubLabel.Text = "Violence District  v19.0"; SubLabel.Position = UDim2.new(0, 82, 0, 16)
...
print("[VD v19.0] Loaded — Saycho | All buttons fixed: OpenBtn+JumpBtn+MoonBtn tap-safe")
