...
-- ============================================================
-- CONFIG TABLE (diambil & disesuaikan dari script pro)
-- ============================================================
local Config = {
    ESP = {
        ShowDistance       = true,
        MaxDistance        = 500,       -- jarak max ESP muncul (studs)
        ShowOnlyClosestHook = false,    -- tampilkan hook terdekat saja
    },
    AutoFeatures = {
        AutoAttack  = false,
        AttackRange = 10,               -- radius auto attack (studs)
    },
    Teleportation = {
        SafeTeleport   = true,          -- disable collision saat teleport
        TeleportOffset = 3,             -- offset Y saat teleport
    },
    Performance = {
        UpdateRate           = 0.5,     -- interval update ESP (detik)
        UseDistanceCulling   = true,    -- skip objek di luar MaxDistance
        MaxESPObjects        = 100,     -- max objek yang di-render ESP
        DisableParticles     = false,
        LowerGraphics        = false,
        DisableShadows       = false,
        ReduceRenderDistance = false,
