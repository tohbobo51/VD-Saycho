...
-- Auto Revive diri sendiri INSTAN (loop)
...
do
    ...
    SurTab:Button({
        ...
        Description = "Fire SkillCheck success 20x → target langsung hidup/full",
        Callback    = function()
            ...
            WindUI:Notify({
                Title   = "Revive",
                Content = ok and "✅ Revive Instan → "..healTargetName or "❌ Gagal: "..tostring(err),
                Duration = 2, Icon = ok and "heart" or "alert-circle"
            })
        end
    })
